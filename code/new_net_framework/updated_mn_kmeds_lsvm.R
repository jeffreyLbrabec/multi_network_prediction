...
write_rds(multi_net_trial_results, here("results/multi_net_linear_results/multi_net_trial_results.rds"))
...
write_rds(final_multi_net_auc, here("results/multi_net_linear_final_predictions/final_multi_net_auc.rds"))
