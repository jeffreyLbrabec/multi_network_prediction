...
dir.create(file.path(here("results"), paste("astro", "rbf", "results", sep = "_")))

res_dir <- here("results/astro_rbf_results")
...
write_rds(astro_trial_results, here("results/astro_rbf_results/astro_trial_rbf_results.rds"))

# Aggregate Model Performance Across Hyper-Parameters ---------------------
plan(multisession)
astro_fold_res <- future_map(astro_trial_results, format_folds, learner = "svm_rbf")
...
write_rds(final_astro_auc, here("results/astro_rbf_final_predictions/final_astro_rbf_auc.rds"))
