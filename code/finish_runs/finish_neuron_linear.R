...
neuron_trial_results <- read_rds(here("results/neuron_linear_results/neuron_trial_linear_results.rds"))

# Aggregate Model Performance Across Hyper-Parameters ---------------------

neuron_fold_res <- map(neuron_trial_results, format_folds, learner = "svm_linear")
...
dir.create(file.path(here("results"), paste("neuron", "linear", "final", "predictions", sep = "_")))
...
final_res_dir <- here("results/neuron_linear_final_predictions")
...
write_rds(final_neuron_auc, here("results/neuron_linear_final_predictions/final_neuron_linear_auc.rds"))
