...
# Read in Data ------------------------------------------------------------
astro_tibble <- read_csv(here("data/astro_tibble.csv"))
astro_trial_results <- read_rds(here("results/astro_linear_results/astro_trial_results.rds"))
...
astro_cv_folds <- nested_cv(astro_tibble,
...
dir.create(file.path(here("results"), paste("astro", "full_linear", "final", "predictions", sep = "_")))

best_astro_mod_list <- list(splits = best_astro_models$splits,
                           models = best_astro_models$models,
                           fold_id = best_astro_models$fold_id)

final_res_dir <- here("results/astro_full_linear_final_predictions")
...
write_rds(final_astro_auc, here("results/astro_full_linear_final_predictions/final_astro_auc.rds"))
