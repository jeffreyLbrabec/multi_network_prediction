...
glia_trial_results <- read_rds(here("results/glia_linear_results/glia_trial_results.rds"))
...
glia_fold_res <- future_map(glia_trial_results, format_folds, learner = "svm_linear")
